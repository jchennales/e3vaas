...
//only interaction with dynamodb

import static com.citigroup.demo.poc.pvd.model.SwiftValidationTransactionKeys.CLIENT_ID;
import static com.citigroup.demo.poc.pvd.model.SwiftValidationTransactionKeys.SWIFT_MESSAGE_TEXT;
import static com.citigroup.demo.poc.pvd.model.SwiftValidationTransactionKeys.SWIFT_MESSAGE_TYPE;
import static com.citigroup.demo.poc.pvd.model.SwiftValidationTransactionKeys.TABLE;
import static com.citigroup.demo.poc.pvd.model.SwiftValidationTransactionKeys.TRANSACTION_ID;
import static com.citigroup.demo.poc.pvd.model.SwiftValidationTransactionKeys.VALIDATION_AT;
import static com.citigroup.demo.poc.pvd.model.SwiftValidationTransactionKeys.VALIDATION_MESSAGE;
import static com.citigroup.demo.poc.pvd.model.SwiftValidationTransactionKeys.VALIDATION_STATUS;
...
public class SwiftValidationTransactionServiceImpl implements SwiftValidationTransactionService {
	...
	public String save(SwiftValidationTransaction swiftValidationTransaction)
		...
		try {
			...
			LOGGER.info("SwiftValidationTransaction {}", swiftValidationTransaction);
